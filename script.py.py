...
class MainWindow(CTk):
    def __init__(self):
        ...
        self.username = "Єгор"
        self.label = None
        self.menu_frame = CTkFrame(self, width=30, height=300,fg_color='black')
        ...
        self.adaptive_ui()
        self.add_message("Демонстрація відображення зображення:", CTkImage(Image.open('kitty.jpg'), size=(300, 300)))
        try:
    ...
    def show_menu(self):
        ...
        elif self.menu_frame.winfo_width() >= 60 and not self.is_show_menu:В
            self.after(10, self.show_menu)
            if self.label:
                self.label.destroy()
    ...
    def add_message(self, message, img=None):
        ...
        if not img:
            ...
            CTkLabel(message_frame, text=message, wraplength=wrapleng_size,
                     text_color='white', image=img, compound='top',ВВ
